      ...
      <main className="mx-auto max-w-6xl px-4 pb-16 pt-6">
        {authLoading && (
          <div className="rounded-2xl border bg-white p-6">
            ...
            <div className="mt-3 h-4 w-80 animate-pulse rounded bg-[#F1F5F9]" />
          </div>
        )}
        ...
        {!authLoading && !authUserId && (
          <div className="rounded-2xl border bg-white p-6">
            ...
            <div className="mt-1 text-sm text-[#475569]">Log in to see your sales history.</div>
            <button
        ...
        {!authLoading && authUserId && (
          <div className="rounded-2xl border bg-white p-6">
            <div className="flex items-center justify-between gap-3">
              <div>
                <div className="text-lg font-semibold text-[#0F172A]">Sales</div>
            ...
            {err && (
              <div className="mt-4 rounded-xl border border-red-200 bg-red-50 p-4 text-sm text-red-700">
                <div className="font-semibold">Couldn’t load sales</div>
                  ...
                  return (
                    <div key={r.id} className="flex items-center gap-4 py-4">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-0.5 text-xs text-[#64748B]">Sold • {formatDate(r.sale_at)}</div>
                      </div>
